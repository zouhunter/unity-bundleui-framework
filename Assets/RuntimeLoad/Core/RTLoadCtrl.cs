...
public class RTLoadCtrl : IRunTimeLoadCtrl
{
    ...
    public void GetGameObjectFromBundle(RTBundleInfo trigger)
    {
    ...
    /// 获取对象实例
    /// </summary>
    void CreateInstance(GameObject prefab, RTBundleInfo trigger)
    {
